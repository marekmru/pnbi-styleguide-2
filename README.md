# Styleguide Plan.net Business Intelligence (v0.1.1) based on current SP Styles

# Installation
* `pnbi-styleguide`: bower install pnbi-styleguide --save

# Dependencies
* `Bootrap v4.0.0-alpha.5`: [GitHub](https://github.com/twbs/bootstrap)

# TODO
* add npm as install possibility
* how to build a new releases?
* how to use exact version of styleguide?
